...
<nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
  ...
  <div className="flex lg:order-2 space-x-3 lg:space-x-0 rtl:space-x-reverse">
    ...
    :""}
        {isLoggedIn?
      (storage?  <button type="button"  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  lg:hidden"><Link to='/files'>{storage}</Link> </button> 
