...
export default function Movierulz() {
  ...
  useEffect(() => {
    ...
    if(queryData){
    fetchData(`https://rsg-movies.vercel.app/api/movierulz/search/${queryData}`)
    }
    else{
